...
HEADERS += src/mainbar.h src/databackend.h src/databackend/mlibdata.h src/databackend/plistdata.h src/databackend/colldata.h src/databackend/xmms2interface.h src/databackend/xmmsqt4.h src/rearpanel.h src/equalizer.h src/mainwindow.h src/options.h src/wikibrowser.h src/lyricbrowser.h src/albumart.h src/panel.h src/medialib.h src/minimode.h src/infoeditor.h src/basicvis.h src/songpositionslider.h src/databackend/panelcontroller.h src/layoutpanel.h src/filebrowser.h src/playlistpanel.h src/collectionbrowser.h src/nicelabel.h src/contextinfo.h src/panelview.h src/webpanel.h src/services/webservice.h src/services/shoutcast.h

SOURCES += src/main.cpp src/mainbar.cpp src/databackend.cpp src/databackend/mlibdata.cpp src/databackend/plistdata.cpp src/databackend/colldata.cpp src/databackend/xmms2interface.cpp src/databackend/xmmsqt4.cpp src/rearpanel.cpp src/equalizer.cpp src/mainwindow.cpp src/options.cpp src/wikibrowser.cpp src/lyricbrowser.cpp src/albumart.cpp src/panel.cpp src/medialib.cpp src/infoeditor.cpp src/basicvis.cpp src/minimode.cpp src/songpositionslider.cpp src/databackend/panelcontroller.cpp src/filebrowser.cpp src/playlistpanel.cpp src/collectionbrowser.cpp src/nicelabel.cpp src/contextinfo.cpp src/panelview.cpp src/webpanel.cpp src/services/shoutcast.cpp
