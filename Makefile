...
# Generated by qmake (2.01a) (Qt 4.3.0) on: Mon Nov 5 14:51:42 2007
...
CFLAGS        = -pipe -g -I/usr/local//include/xmms2 -I/usr/local//include/xmms2 -Wall -W -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -g -I/usr/local//include/xmms2 -I/usr/local//include/xmms2 -Wall -W -Wno-unused-parameter -D_REENTRANT $(DEFINES)
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib -lQtNetwork -L/usr/local//lib -lxmmsclient -L/usr/local//lib -lxmmsclient -lxmmsclient++ -lQtXml -lQtGui -lQtNetwork -lQtCore -lpthread
AR            = ar cqs
RANLIB        = 
